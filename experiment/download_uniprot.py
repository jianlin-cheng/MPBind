...
def main():
    ...
    pdb_filepaths = glob("/cluster/pixstor/chengji-lab/yw7bh/alphafold_structures/UP000005640_9606_HUMAN_v2/*.pdb")

    # get all uniprot ids
    info_l = []
    for pdb_filepath in pdb_filepaths:
        # extract identification key
        m = re.match(r'/cluster/pixstor/chengji-lab/yw7bh/alphafold_structures/[A-Z0-9]*_[0-9]*_([A-Z0-9]*)_v2/AF-([A-Z0-9]*)-(F[0-9]*)-model_v2.pdb', pdb_filepath)
