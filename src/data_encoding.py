...
# standard elements (sorted by aboundance) (29)+!
...
# standard residue names: AA/RNA/DNA (sorted by aboundance) (28)+!
...
std_names = np.array([
    ...
    "O5'", "O4'", "C1'", "C2'", "O2'", 'o''OP1', 'OP2', 'N9', 'N2', 'O6',
    'N7', 'C8', 'N1', 'N3', 'C2', 'C4', 'C6', 'C5', 'N6', 'N4', 'O2',
    'O4'
])

# resname categories    # ['DNA','RNA','CA','MN','MG','ATP','HEME'] for Graphbind
categ_to_resnames = {
   ...
   "ligand": ['SO4', 'NAG', 'PO4', 'EDO', 'ACT', 'MAN', 'HEM', 'FMT', 'BMA',
               ...
               'AMP', 'NDP', 'SAH', 'OXY'], # 31
    "lipid": ['PLM', 'CLR', 'CDL', 'RET'],  # 4

    # "ion_r": ['CL',  'NA', 'K', 'IOD', 'CD', 'CU', 'FE', 'NI', 'SR', 'BR', 'CO', 'HG'],  # 12
    # "ion_s1": ['ZN'],
    # "ion_s2": ['CA'],
    # "ion_s3": ['MN'],
    # "ion_s4": ['MG'], # 4    
